...
$counter = 'countere2.txt'; // text file to store download count - create manually and put a 0 (zero) in it to begin the count 
$download = '../files/LOBE_LITE v.1.3_Rubric.pdf'; // the link to your download file 
