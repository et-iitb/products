...
$counter = 'counter4.txt'; // text file to store download count - create manually and put a 0 (zero) in it to begin the count 
$download = '../resources/geo/markers/hexagonmarker.jpg'; // the link to your download file 
