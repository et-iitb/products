																...
																<li>Smartphone Colorimetry<img src="img/play-arrow1.png">
																	...
																	<li>Evaluation Instruments <img src="img/play-arrow1.png">
																		<ul>
																			...
																			<a href="javascript:void(0)"> <li>TEC</li></a>
																		</ul>
																	</li>
...
<div class="fullblk clearfix">
	<div class="side-panel">
		<ul>
			<li class="side-learn slidepanelactive"><a href="#Learning" class="Learning" >What is TEC</a></li>
			<!-- <li class="side-purp"><a href="#Purpose" class="Purpose">Purpose of using G-v-G</a></li> -->
			<li class="side-res"><a href="#Resources" class="Resources" >What TEC measures</a></li>
			<li class="sideget"><a href="#Getting" class="Getting" >Download TEC</a></li>
		</ul>
	</div>
	<div class="about_lab GVG-block">
		<div class="width-container">
			<div class="about-div clearfix gvg-div">
				<div id="Learning">
					<h3>Textbook Evaluation Checklists for Science and Mathematics (TEC)</h3><br/>

					<h4 style="padding-bottom: 0px;">About TEC:</h4>
						<p style="padding-top: 15px;">TEC for Science and Mathematics are meant to assist school principals and teachers choose high-quality textbooks for their students from the wide array of textbooks currently available.<br>
TEC takes Next Generation Science Standards (NGSS, USA) and National Curriculum Framework (NCF, India) as defining standards for evaluation of skills, knowledge and process in Science and Mathematics.</p><br/>
				...
				<div class="gvg-content">
					<div class="gvg-cont-div">
						<div id="Resources">
							...
							<ul>
								<li>EQuIP (adapted to Indian context)y</li>
						...
						<div id="Getting" class="tec_download">
							<h4>Download TEC</h4>
							<ul>
								 <li style="list-style: none; margin-left: -1.8%;">Two separate checklists for evaluating quality of Science and Mathematics textbook for schools (TEC_Science & TEC_Mathematics) are given below.Each checklist contains subject-specific illustrative examples and explanations for easy use by teachers.Usability of both checklist tested with subject matters experts.</li>
							</ul>
								<table cellspacing="0" style="text-align: center !important;" border="1" >
									...
									<tr>
										...
										<td>TEC_Science</td>
									<!-- 	<td><img src="img/lobe_lite.jpg" style="margin: 10px 10px 10px 10px;" width="90%"></td> -->
										<!-- <td style="text-align: justify !important;">LOBE_LITE is an abridged version of LOBE_PREMIUM consisting of 10-11 questions. It is a 4-scale (Missing, Inadequate, Almost, Adequate) theory-informed checklist for quality evaluation of learning objects.
										Use LOBE_LITE when you want to do a quick evaluation of the quality of the selected learning object. The robustness of the instrument cannot be vouched for. For thorough evaluation, use LOBE_PREMIUM (39 questions) that has been tested for validity & reliability.</td> -->
										<td><a href="counters/counterc1.html">Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterc1.txt'); ?></center></td>
									</tr>

									<tr>

										<td>TEC_Mathematics</td>
										<!-- <td><img  src="img/lobe_lite.jpg" style="padding: 10px 10px 10px 10px;" width="90%"></td> -->
										<!-- <td style="text-align: justify !important;">LOBE_PREMIUM is a 39-question rubric covering the dimensions of : Content quality (C) (7 questions), Pedagogical alignment (P) (16 questions), Design efficacy (10 questions) and Technology integration (T) (5 questions).It is a 4-scale (Missing, Inadequate, Almost, Target) rubric that you can use for a thorough evaluation. Robustness of the rubric has been tested with educational technology experts. </td> -->
										<td><a href="counters/counterc2.html">Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterc2.txt'); ?></center></td>
									</tr>
...
<script>
	...
	$(document).ready(function () {
		$(".Learning").click(function() {
		    $("#Learning").show();
		    $("#Purpose, #Getting, #Resources").hide();
		...
		$(".Purpose").click(function() {
		    $("#Purpose").show();
		    $("#Learning, #Getting, #Resources").hide();
		...
		$(".Getting").click(function () {
			$("#Getting").show();
		    $("#Purpose, #Learning, #Resources").hide();
