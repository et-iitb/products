...
<body>
	...
	<div class="fullblk clearfix">
		<div class="side-panel">
			<ul>
				<li class="side-learn slidepanelactive"><a href="#Learning" class="Learning" style="font-size:1.2vw;">Augmented Reality Markers</a></li>
				<!-- <li class="side-purp"><a href="#Purpose" class="Purpose">Purpose of using G-v-G</a></li> -->
				<li class="side-res"><a href="#Resources" class="Resources" style="font-size:1.2vw;">Blender 3D Models</a></li>
				<!-- <li class="sideget"><a href="#Getting" class="Getting" style="font-size:1.2vw;">Learning Design Constructors</a></li> -->
			</ul>
		</div>
				...
				<div class="about-div clearfix gvg-div">
					<div id="Learning">
						...
						<div class="table-users">
							<h3>GeoSolVAR: Augmented Reality Markers </h3>
							<br>
							<table cellspacing="1">
								...
								<tr>
									...
									<td>1</td>
									<td>Blue Cubes</td>
									<td><img src="resources/geo/markers/bluecubesmarker.jpg" ></td>
									<td><a href="counters/counter1.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter1.txt'); ?></center></td>
								</tr>
								...
								<tr>
									...
									<td>2</td>
									<td>Car</td>
									<td><img src="resources/geo/markers/carmarker.jpg" ></td>
									<td><a href="counters/counter2.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter2.txt'); ?></center></td>
								</tr>
								...
								<tr>
									...
									<td>3</td>
									<td>Green Cubes</td>
									<td><img src="resources/geo/markers/greencubesmarker.jpg" ></td>
									<td><a href="counters/counter3.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter3.txt'); ?></center></td>
								</tr>
								...
								<tr>
									...
									<td>4</td>
									<td>Hexagon</td>
									<td><img src="resources/geo/markers/hexagonmarker.jpg" ></td>
									<td><a href="counters/counter4.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter4.txt'); ?></center></td>
								</tr>
								<tr>

									<td>5</td>
									<td>House</td>
									<td><img src="resources/geo/markers/housemarker.jpg" ></td>
									<td><a href="counters/counter5.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter5.txt'); ?></center></td>
								</tr>
								<tr>

									<td>6</td>
									<td>Purple Cube</td>
									<td><img src="resources/geo/markers/purplemarker.jpg" ></td>
									<td><a href="counters/counter6.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter6.txt'); ?></center></td>
								</tr>
								...
								<tr>
									...
									<td>7</td>
									<td>Red Cube</td>
									<td><img src="resources/geo/markers/redcubemarker.jpg" ></td>
									<td><a href="counters/counter7.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter7.txt'); ?></center></td>
								</tr>
								<tr>

									<td>8</td>
									<td>Truck</td>
									<td><img src="resources/geo/markers/truckmarker.jpg" ></td>
									<td><a href="counters/counter8.html">Download Link</a></td>
									<td><center><?php echo file_get_contents('counters/counter8.txt'); ?></center></td>
								</tr>
					...
					<div id="Resources">
						<div class="table-users">
							...
							<h3>GeoSolVAR : Blender 3D Models<h3>
								...
								<table cellspacing="1">
									...
									<tr>
										...
										<td>Cubes</td>
										<td><img src="resources/geo/markers/bluecubesmarker.jpg" ></td>
										<td><a href="counters/counterb1.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb1.txt'); ?></center></td>
									</tr>
									...
									<tr>
										...
										<td>Car</td>
										<td><img src="resources/geo/markers/carmarker.jpg" ></td>
										<td><a href="counters/counterb2.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb2.txt'); ?></center></td>
									</tr>
									...
									<tr>
										...
										<td>Green Cube</td>
										<td><img src="resources/geo/markers/greencubesmarker.jpg" ></td>
										<td><a href="counters/counterb3.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb3.txt'); ?></center></td>
									</tr>
									...
									<tr>
										...
										<td>Hexagon</td>
										<td><img src="resources/geo/markers/hexagonmarker.jpg" ></td>
										<td><a href="counters/counterb4.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb4.txt'); ?></center></td>
									</tr>
									<tr>
										...
										<td>House</td>
										<td><img src="resources/geo/markers/housemarker.jpg" ></td>
										<td><a href="counters/counterb5.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb5.txt'); ?></center></td>
									</tr>
									<tr>
										...
										<td>Purple Cube</td>
										<td><img src="resources/geo/markers/purplemarker.jpg" ></td>
										<td><a href="counters/counterb6.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb6.txt'); ?></center></td>
									</tr>
									...
									<tr>
										...
										<td>Red Cube</td>
										<td><img src="resources/geo/markers/redcubemarker.jpg" ></td>
										<td><a href="counters/counterb7.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb7.txt'); ?></center></td>
									</tr>
									<tr>
										...
										<td>Truck</td>
										<td><img src="resources/geo/markers/truckmarker.jpg" ></td>
										<td><a href="counters/counterb8.html">Download Link</a></td>
										<td><center><?php echo file_get_contents('counters/counterb8.txt'); ?></center></td>
									</tr>
