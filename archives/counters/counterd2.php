...
$counter = 'counterd2.txt'; // text file to store download count - create manually and put a 0 (zero) in it to begin the count 
$download = '../files/LOBE_PREMIUM.pdf'; // the link to your download file 
