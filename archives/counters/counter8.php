...
$counter = 'counter8.txt'; // text file to store download count - create manually and put a 0 (zero) in it to begin the count 
$download = '../resources/geo/markers/truckmarker.jpg'; // the link to your download file 
